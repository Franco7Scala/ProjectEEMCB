...
for output_selected in range(0, output_quantity):
    ...
    train_sizes_re, train_scores_svr_re, test_scores_svr_re = learning_curve(svr_results, X[:train_size], y[:train_size], train_sizes=numpy.linspace(0.1, 1, 10), scoring=make_scorer(
