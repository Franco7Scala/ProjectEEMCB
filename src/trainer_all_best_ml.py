...
for nation in nations:
    Support.colored_print("Current nation: " + nation, "Red")

    training_sets = ["/home/francesco/Scrivania/datas/other_ts_on/" + nation + "/training/training_set_wp.txt", \
                     "/home/francesco/Scrivania/datas/other_ts_on/" + nation + "/training/training_set_wpaw.txt"]
    test_sets = ["/home/francesco/Scrivania/datas/other_ts_on/" + nation + "/test/test_set_wp.txt", \
                 "/home/francesco/Scrivania/datas/other_ts_on/" + nation + "/test/test_set_wpaw.txt"]
    path_out = ["/home/francesco/Scrivania/out/" + nation + "/wp", \
                "/home/francesco/Scrivania/out/" + nation + "/wpaw"]
    ...
    for current_data_set in range(0, len(training_sets)):
        ...
        for current_model in range(1, (model_quantity + 1)):
            ...
            for output_selected in range(0, output_quantity):
                ...
                train_sizes_r2, train_scores_model_r2, test_scores_model_r2 = learning_curve(model, X[:train_size],
                                                                                             y[:train_size],
                                                                                             train_sizes=numpy.linspace(
                                                                                                 0.1, 1, 10),
                                                                                             scoring="r2", cv=10)
                train_sizes_re, train_scores_model_re, test_scores_model_re = learning_curve(model, X[:train_size],
                                                                                             y[:train_size],
                                                                                             train_sizes=numpy.linspace(
                                                                                                 0.1, 1, 10),
                                                                                             scoring=make_scorer(
                                                                                                 scoring.relative_error),
                                                                                             cv=10)
