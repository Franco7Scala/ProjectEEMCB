...
for output_selected in range(0, output_quantity):
    ...
    train_sizes_re, train_scores_tree_re, test_scores_tree_re = learning_curve(tree_results, X[:train_size], y[:train_size], train_sizes=numpy.linspace(0.1, 1, 10), scoring=make_scorer(scoring.relative_error), cv=10)
